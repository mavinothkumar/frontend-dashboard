        ...
        public function sub_menus()
        {
            $options = array(
                    'fed_social_connect_settings' => array(
                            ...
                            'callable'  => array('object' => $this, 'method' => 'pro'),
                            'arguments' => '',
                    ),
            ...
            <div class="row m-b-20">
                <div class="col-md-4">
                    <form method="post"
                        ...
                        <button type="submit" style="
                                background:url(<?php echo plugins_url('assets/admin/images/pro/buy-now-29.png',
                                BC_FED_PLUGIN) ?>);
                ...
                <div class="col-md-4">
                    <form method="post"
                        ...
                        <button type="submit" style="
                                background:url(<?php echo plugins_url('assets/admin/images/pro/buy-now-99.png',
                                BC_FED_PLUGIN) ?>);
                                background-repeat: no-repeat;
                                width:200px;
                                height: 148px;

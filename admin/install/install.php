    ...
    if (isset($_GET['page']) && in_array($_GET['page'], fed_get_script_loading_pages(), false)) {
        ...
        if ( ! $get_notification) {
            ...
            <div class="notice notice-success">
                <p>
                    <b><?php _e('If you need help in configuring the frontend dashboard, please watch the videos here',
                            'frontend-dashboard');
                        ?>
                    </b>
                    <a href="https://buffercode.com/category/name/frontend-dashboard"><?php _e('Frontend Dashboard Instructions',
                ...
                <p>
                    ...
                    <span class="fed_message_delete"
                          data-url="<?php echo admin_url('admin-ajax.php?action=fed_message_form&fed_message_nonce='.wp_create_nonce('fed_message_nonce')) ?>">Don't show again</span>
                </p>
            </div>
            <?php
        }

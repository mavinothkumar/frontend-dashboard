...
function fed_restrict_admin_area()
{
    ...
    if ($restrict_admin_area && $current_user_role && ! (defined('DOING_AJAX') && DOING_AJAX) && isset($restrict_admin_area['restrict_wp']['role']) && array_key_exists($current_user_role,
                    $restrict_admin_area['restrict_wp']['role']) && is_admin()) {

            ...
            'content'  => array(
                    'user_login'    => array(
                            'name'        => sprintf(
                                    ...
                                    esc_html__('%s',
                                    'frontend-dashboard'), $login_info['user_login']['label_name']),

                            'input'       => fed_input_box('user_login',
                                    array(
                                            'placeholder' => sprintf(
                                                    /* Translators:  %s: User Login Placeholder */
                                                    esc_html__('%s',
                                                    'frontend-dashboard'), $login_info['user_login']['placeholder']),
                                    ), 'single_line'),
                            'input_order' => 7,
                    ),
                    'user_password' => array(
                            'name'        => sprintf(
                                    ...
                                    esc_html__('%s',
                                    'frontend-dashboard'), $login_info['user_pass']['label_name']),
                            'input'       => fed_input_box('user_password',
                                    array(
                                            'placeholder' => sprintf(
                    ...
                    'remember'      => array(
                            ...
                            'input'       => fed_input_box('remember', array(
                                    'name'  => 'remember',
                                    'label' => apply_filters('fed_login_remember_me',
    ...
    return array(
            ...
            'content'  => array(
                    ...
                    'confirmation_password' => array(
                            ...
                            'input'       => fed_input_box('confirmation_password',
                    ...
                    'key'                   => array(
                            'name'        => '',
                            'input'       => fed_input_box('key',
                                    array('value' => isset($_GET['key']) ? $_GET['key'] : ''), 'hidden'),
                            'input_order' => 30,
                    ),
                    'login'                 => array(
                            'name'        => '',
                            'input'       => fed_input_box('login',
                                    array('value' => isset($_GET['login']) ? $_GET['login'] : ''), 'hidden'),
                            'input_order' => 30,
                    ),
            ),
            'selected' => false,

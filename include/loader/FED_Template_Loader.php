...
//	 * @type string
//	 */
//	protected $theme_template_directory = 'fed-templates'; // or 'your-plugin-templates' etc.
//
//	/**
...
//	 * @type string
//	 */
//	protected $plugin_directory = BC_FED_PLUGIN_DIR; // or plugin_dir_path( dirname( __FILE__ ) ); etc.
//
//	/**
...
//	 * @since 1.0.0
//	 *
//	 * @uses FED_Template_Loader::get_template_possble_parts() Create file names of templates.
//	 * @uses FED_Template_Loader::locate_template() Retrieve the name of the highest priority template
//	 *     file that exists.
//	 *
//	 * @param string  $slug
...
//	 * @since 1.0.0
//	 *
//	 * @uses FED_Tech_Loader::get_template_paths() Return a list of paths to check for template locations.
//	 *
...
if ( ! class_exists( 'FED_Template_Loader' ) ) {
	...
	class FED_Template_Loader {
		 ...
		 * @var string
		 */
		protected $plugin_directory = BC_FED_PLUGIN_DIR;
